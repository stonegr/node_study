    ...
    (e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"),
      (r = {
        ...
        randomBytes: function (i) {
          for (var e = []; i > 0; i--) e.push(Math.floor(256 * Math.random()));
          return e;
        },
        ...
        bytesToHex: function (i) {
          for (var e = [], r = 0; r < i.length; r++)
            e.push((i[r] >>> 4).toString(16)), e.push((15 & i[r]).toString(16));
          return e.join("");
        },
        ...
        base64ToBytes: function (i) {
          ...
          for (var r = [], t = 0, o = 0; t < i.length; o = ++t % 4)
            0 != o &&
              r.push(
                ((e.indexOf(i.charAt(t - 1)) & (Math.pow(2, -2 * o + 8) - 1)) <<
                  (2 * o)) |
...
let cate = args[0] ?? "twitter";
let secrate = args[1] ?? "2HT8gjE3xL";
let time = args[2] ?? Date.now();
let web_site =
  args[3] ?? "https://x.com/wshngknshji1/status/1915975184034763111?s=09";

console.log(jm(web_site + cate + time + secrate));
